...
cuando conteste a la carta, y escríbelos en `clientes/cosmetic-christ.json`.

**7 huecos.** Después: `node webs-locales/generar.mjs clientes/cosmetic-christ.json`
...
> Was soll bei Google unter dem Namen stehen?
  ...
  - `seo.descripcion` — Cosmetic Christ in Reinbek: Kosmetikstudio. [bestätigen]
...
> Welche Leistungen bieten Sie an, und was kosten sie?
  ...
  - `secciones[0].items[0].precio` — ab [bestätigen] €
  - `secciones[0].items[1].precio` — [bestätigen] €
  - `secciones[0].items[2].precio` — ab [bestätigen] €
  - `secciones[0].items[3].precio` — [bestätigen] €
...
| Dato | Valor |
| --- | --- |
| Nombre | Cosmetic Christ |
| Tipo | Kosmetikstudio |
| Ciudad | Reinbek |
| Teléfono | +49 40 24433614 |
| Dirección | Auf dem Großen Ruhm 67, 21465 Reinbek |
