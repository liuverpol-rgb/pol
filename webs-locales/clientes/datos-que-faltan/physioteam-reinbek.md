# Physioteam Reinbek UG

Datos que faltan para dejar su web terminada. Pregúntalos en la llamada o
cuando conteste a la carta, y escríbelos en `clientes/physioteam-reinbek.json`.

**9 huecos.** Después: `node webs-locales/generar.mjs clientes/physioteam-reinbek.json`
...
> Was soll bei Google unter dem Namen stehen?
  ...
  - `seo.descripcion` — Physioteam Reinbek UG in Reinbek: Physiotherapie. [bestätigen]
...
| Dato | Valor |
| --- | --- |
| Nombre | Physioteam Reinbek UG |
| Tipo | Physiotherapie |
| Ciudad | Reinbek |
| Teléfono | +49 40 72810720 |
| Dirección | Bergstraße 4, 21465 Reinbek |
