# Physiotherapie Zietz und Weber

Datos que faltan para dejar su web terminada. Pregúntalos en la llamada o
cuando conteste a la carta, y escríbelos en `clientes/zietz-weber.json`.

**9 huecos.** Después: `node webs-locales/generar.mjs clientes/zietz-weber.json`
...
> Was soll bei Google unter dem Namen stehen?
  ...
  - `seo.descripcion` — Physiotherapie Zietz und Weber in Reinbek: Physiotherapie. [bestätigen]
...
| Dato | Valor |
| --- | --- |
| Nombre | Physiotherapie Zietz und Weber |
| Tipo | Physiotherapie |
| Ciudad | Reinbek |
| Teléfono | +49 40 7227696 |
| Dirección | Am Rosenplatz 17, 21465 Reinbek |
