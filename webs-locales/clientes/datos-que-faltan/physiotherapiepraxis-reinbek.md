# Physiotherapiepraxis Reinbek

Datos que faltan para dejar su web terminada. Pregúntalos en la llamada o
cuando conteste a la carta, y escríbelos en `clientes/physiotherapiepraxis-reinbek.json`.

**9 huecos.** Después: `node webs-locales/generar.mjs clientes/physiotherapiepraxis-reinbek.json`
...
> Was soll bei Google unter dem Namen stehen?
  ...
  - `seo.descripcion` — Physiotherapiepraxis Reinbek in Reinbek: Physiotherapie. [bestätigen]
...
| Dato | Valor |
| --- | --- |
| Nombre | Physiotherapiepraxis Reinbek |
| Tipo | Physiotherapie |
| Ciudad | Reinbek |
| Teléfono | +49 40 32086646 |
| Dirección | Am Rosenplatz 3, 21465 Reinbek |
